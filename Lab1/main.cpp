...
int main() {
    ...
    /*
    for (LinkedList<int>::Iterator it = linkedListSequence->begin();
         it != linkedListSequence->end(); ++it)
        std::cout << *it << " ";

    for(DynamicArray<int>::Iterator it = arraySequence->begin(); it != arraySequence->end(); it++)
    {
        std::cout<<*it<<" ";
    };
*/
    ...
    iSort->InsertionSort(arraySequenceInsertionSort->begin(), arraySequenceInsertionSort->rbegin(), comparator->increase);
    ...
    iSort1->QuickSortList(linkedListSequenceQuickSort->begin(), linkedListSequenceQuickSort->rbegin(), comparator->increase);
    ...
    iSort1->MergeSortList(linkedListSequenceMergeSort->begin(), linkedListSequenceMergeSort->rbegin(), comparator->increase);
    ...
    iSort1->InsertionSort(linkedListSequenceInsertionSort->begin(), linkedListSequenceInsertionSort->rbegin(), comparator->increase);
